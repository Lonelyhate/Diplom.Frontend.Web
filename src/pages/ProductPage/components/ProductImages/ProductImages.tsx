...
const ProductImages: FC<IProductImages> = ({product}) => {
    ...
    return (
        <div className="product-images__slider">
            <div className="product-images__pagination">
            </div>
            <Swiper
                effect={"coverflow"}
                grabCursor={true}
                ...
                pagination={{
                    ...
                    renderBullet: function (index, className) {
                        ...
                        return '<span style="background-image: url(' +  img + ');"  class="' + className + '">' + "</span>";
                    },
                }}
            ...
            >
                {imgs && imgs.map(item => (
                    <SwiperSlide key={item} >
                        <img className={"product-images__img"} src={`https://localhost:7081/${item}`} alt=""/>
                    </SwiperSlide>
                ))}
            </Swiper>
        </div>
